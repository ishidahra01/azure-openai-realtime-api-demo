...
type Parameters = {
	...
	onReceivedTranscriptResponseDone?: (message: TranscriptDone) => void;
...
export default function useRealTime({
	...
	onReceivedTranscriptResponseDone,
    ...
    const startSession = () => {
		...
		console.log("enableInputAudioTranscription:", enableInputAudioTranscription);
    ...
    const onMessageReceived = (event: MessageEvent<any>) => {
        ...
        switch (message.type) {
			...
			case "response.audio_transcript.done":
				...
				onReceivedTranscriptResponseDone?.(message as TranscriptDone);
                break;
			default:
    ...
    return { startSession, addUserAudio, inputAudioBufferClear, setSystemPrompt };
}
